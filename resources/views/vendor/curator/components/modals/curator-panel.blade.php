<div
    ...
    class="curator-panel h-full flex flex-col"
>
    <!-- Toolbar -->
    ...
    <div class="flex-1 relative flex flex-col lg:flex-row overflow-hidden">
        ...
        <div class="curator-panel-gallery flex-1 h-full overflow-auto p-4">
            <ul class="curator-picker-grid" style="display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 1rem !important;">
